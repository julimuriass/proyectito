...
def create_app(test_config=None): 
    ...
    # add_url_rule() associates the endpoint name 'index' w the / irl so that url_for('index') or url_for('blog.index') will both work, generating the same / URL either way.
